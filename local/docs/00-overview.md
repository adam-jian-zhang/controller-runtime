# Controller-Runtime Architecture Overview
...
sequenceDiagram
    ...
    participant Cache as Cache/Informer
    ...
    K8s->>Cache: Watch events
    Cache->>Source: Object changed
    Source->>Handler: Process event
    Handler->>Queue: Enqueue reconcile request
    Queue->>Controller: Dequeue request
    Controller->>Reconciler: Reconcile(ctx, request)
    Reconciler->>Client: Get/List (from cache)
    Reconciler->>Client: Create/Update/Delete (to API)
    Client->>K8s: API calls
    Reconciler->>Controller: Return result
    Controller->>Queue: Requeue if needed
```
...
graph LR
    subgraph "Read Path"
        R1[Reconciler] -->|Get/List| C1[Client]
        C1 -->|Read| Cache
        Cache -->|Informer| API1[API Server]
    end
    
    subgraph "Write Path"
        R2[Reconciler] -->|Create/Update/Delete| C2[Client]
        C2 -->|Write| API2[API Server]
    end
...
- [Manager Package](./01-manager.md)
- [Controller Package](./02-controller.md)
- [Reconciler Package](./03-reconcile.md)
- [Builder Package](./04-builder.md)
- [Client Package](./05-client.md)
- [Cache Package](./06-cache.md)
- [Source Package](./07-source.md)
- [Handler Package](./08-handler.md)
- [Predicate Package](./09-predicate.md)
- [Webhook Package](./10-webhook.md)
- [Additional Packages](./11-additional-packages.md)
